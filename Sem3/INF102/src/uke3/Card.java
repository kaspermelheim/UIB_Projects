...
public class Card{
	...
	//names and suits are lists of all the options for valid cards
	//We could have methods instead, then we would have had the option to e.g. change the language
	 ...
	 */
	public static List<Card> spawnDeck() {
